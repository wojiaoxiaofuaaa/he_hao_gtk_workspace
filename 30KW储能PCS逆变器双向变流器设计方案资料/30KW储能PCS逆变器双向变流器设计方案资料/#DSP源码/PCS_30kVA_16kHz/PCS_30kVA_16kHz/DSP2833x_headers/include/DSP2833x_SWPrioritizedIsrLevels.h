...
// 16 = lowest priority
#if (!SCI_SCOPE)
#define	INT1PL      2  //2        // Group1 Interrupts (PIEIER1) AD      INT1.6
#define	INT2PL      1  //1        // Group2 Interrupts (PIEIER2) Tz      INT2.1
#define	INT3PL      0  //0        // Group3 Interrupts (PIEIER3) EPWM    NC
#define	INT4PL      6  //5        // Group4 Interrupts (PIEIER4) ECAP    INT4.1
#define	INT5PL      0  //0        // Group5 Interrupts (PIEIER5) EQEP    NC
#define	INT6PL      0  //4        // Group6 Interrupts (PIEIER6) SPI     NC
#define	INT7PL      0  //0        // reserved                            NC
#define	INT8PL      7  //0        // reserved                    I2C     NC 
#define	INT9PL      5  //4        // SCIA,SCIB,ECANA,ECANB               INT9.1 SCIRXA .2TX
#define	INT10PL     0  //0        // reserved
#define	INT11PL     0  //0        // reserved
#define	INT12PL     4  //0        // reserved  XINT3
#define	INT13PL     3  //3        // XINT13    Timer0
#define	INT14PL     9  //5        // INT14 (TINT2)
#define	INT15PL     0  //5        // DATALOG
#define	INT16PL     0  //5        // RTOSINT
#endif

//*/
///*
#if SCI_SCOPE
#define	INT1PL      3//2+1        // Group1 Interrupts (PIEIER1) AD
#define	INT2PL      1//1        // Group2 Interrupts (PIEIER2) TZ
#define	INT3PL      0//0        // Group3 Interrupts (PIEIER3) EPWM
#define	INT4PL      6//5+1      // Group4 Interrupts (PIEIER4) ECAP
#define	INT5PL      0//0        // Group5 Interrupts (PIEIER5) EQEP
#define	INT6PL      5//4+1      // Group6 Interrupts (PIEIER6) SPI
#define	INT7PL      0//0        // reserved
#define	INT8PL      7//0        // reserved
#define	INT9PL      2//4-2      // Group9 Interrupts (PIEIER9) SCI
#define	INT10PL     0//0        // reserved
#define	INT11PL     0//0        // reserved
#define	INT12PL     2//0        // reserved
#define	INT13PL     4//3+1      // XINT13 Timer0
#define	INT14PL     9//5+2      // INT14 (TINT2)
#define	INT15PL     0//5+2      // DATALOG
#define	INT16PL     0//5+2      // RTOSINT
#endif
//*/
...
#define	G17PL       0        // TINT0       (CPU Timer 0)
#define	G18PL       3        // WAKEINT     (WD/LPM)

#define	G21PL       1        // EPWM1_TZINT (ePWM1 Trip)
#define	G22PL       1        // EPWM2_TZINT (ePWM2 Trip)
#define	G23PL       1        // EPWM3_TZINT (ePWM3 Trip)
#define	G24PL       6        // EPWM4_TZINT (ePWM4 Trip)
#define	G25PL       6        // EPWM5_TZINT (ePWM5 Trip)
...
#define	G34PL       6        // EPWM4_INT   (ePWM4 Int)
#define	G35PL       6        // EPWM5_INT   (ePWM5 Int)
...
#define	G81PL       3        // I2CINT1A    (I2C-A)
#define	G82PL       4        // I2CINT2A    (I2C-A)
...
#define	G91PL       5        // SCIRXINTA   (SCI-A)
#define	G92PL       6        // SCITXINTA   (SCI-A)
#define	G93PL       7        // SCIRXINTB   (SCI-B)
#define	G94PL       8        // SCITXINTB   (SCI-B)
