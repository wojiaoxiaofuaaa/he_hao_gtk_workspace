...
INT32S dwRatePower = 30000;  //30kW
INT16S wRateInvCurrPeak = 13064;   //Q8 480 30kW
INT16S wRateInvCurrInv = 10274;   //16384*32/wRateInvCurrPeak
INT16S wInvCurrPeakMax = 13064;   //Q8 480 30kW
INT16S wInvCurrResolving = 512;
INT16S wRateGridLineVol = 7680;
INT16S wpuGridLineVol = 16384;
INT16S wRateRmsCurr = 9238;    //30KW/480/1.732 Q8  
...
#pragma DATA_SECTION(uwSysMode,"RamSafetyProt");
#pragma DATA_SECTION(fError,"RamSafetyProt");
#pragma DATA_SECTION(fGridRelayCtr,"RamSafetyProt");
#pragma DATA_SECTION(fDCRelayPCtr,"RamSafetyProt");
#pragma DATA_SECTION(fDCRelayNCtr,"RamSafetyProt");
#pragma DATA_SECTION(fDCSoftRelayCtr,"RamSafetyProt");
#pragma DATA_SECTION(fAuxiRelayCtr,"RamSafetyProt");
#pragma DATA_SECTION(fGridRelayCtrBak,"RamSafetyProt");
#pragma DATA_SECTION(fDCRelayCtrBak,"RamSafetyProt");
#pragma DATA_SECTION(fAuxiRelayCtrBak,"RamSafetyProt");
#pragma DATA_SECTION(dwregister0,"RamSafetyProt");
#pragma DATA_SECTION(dwregister1,"RamSafetyProt");
#pragma DATA_SECTION(dwregister2,"RamSafetyProt");
#pragma DATA_SECTION(wregister0,"RamSafetyProt");
#pragma DATA_SECTION(wregister1,"RamSafetyProt");
#pragma DATA_SECTION(wRegistercheckFlag,"RamSafetyProt");
/*********************************************************************
...
INT16U uwpuPower,uwpuPowerTmp;
    ...
    uwpuPower = (udwAppPower<<8)/dwRatePower;//Q12
    
    if((fBiDirDCEnOut == 1)||(fBiDirDCEnOut == 2))
    {
    	dwTemp = labs(dwPPower);
    	uwpuPowerTmp = (dwTemp<<9)/dwRatePower;//Q12 ,Only One DC Runing So mul 2
    }
    else
    {
    	dwTemp = labs(dwPPower);
    	uwpuPowerTmp = ((INT32U)dwTemp<<8)/dwRatePower;//Q12
    }
...
/*********************************************************************
Function name: void sSysRateCoeffChangeInit(void)
...
Return: 	INT16U	
*********************************************************************/
void sSysRateCoeffChangeInit(void)
{
static INT16S wSysFrebak = 0;
    ...
    {
    	if(wEepromRateVolSel == 0)
        {
    	    uwHalfCycSampNum = cHalfCycSampNum60Hz400V;
            uwHalfCysRateVolSqure = cHalfCysRateVolSqure60Hz400V;
            udwHalfCysRateVolSqure0R81 = cHalfCysRateVolSqure0R8160Hz400V;
            udwHalfCysRateVolSqure1R21 = cHalfCysRateVolSqure1R2160Hz400V;
            udwHalfCysRateVolSqure0R2 = cHalfCysRateVolSqure0R260Hz400V;
            udwHalfCysRateVolSqure0R01 = cHalfCysRateVolSqure0R0160Hz400V;    	    
        }
        else
        {
        	uwHalfCycSampNum = cHalfCycSampNum60Hz480V;
            uwHalfCysRateVolSqure = cHalfCysRateVolSqure60Hz480V;
            udwHalfCysRateVolSqure0R81 = cHalfCysRateVolSqure0R8160Hz480V;
            udwHalfCysRateVolSqure1R21 = cHalfCysRateVolSqure1R2160Hz480V;
            udwHalfCysRateVolSqure0R2 = cHalfCysRateVolSqure0R260Hz480V;
            udwHalfCysRateVolSqure0R01 = cHalfCysRateVolSqure0R0160Hz480V;
        }
    }
    else
    {
    	if(wEepromRateVolSel == 0)
        {
            ...
            uwHalfCysRateVolSqure = cHalfCysRateVolSqure50Hz400V;
            udwHalfCysRateVolSqure0R81 = cHalfCysRateVolSqure0R8150Hz400V;
            udwHalfCysRateVolSqure1R21 = cHalfCysRateVolSqure1R2150Hz400V;
            udwHalfCysRateVolSqure0R2 = cHalfCysRateVolSqure0R250Hz400V;
            udwHalfCysRateVolSqure0R01 = cHalfCysRateVolSqure0R0150Hz400V;   	    
        }
        else
        {
        	uwHalfCycSampNum = cHalfCycSampNum50Hz480V;
            uwHalfCysRateVolSqure = cHalfCysRateVolSqure50Hz480V;
            udwHalfCysRateVolSqure0R81 = cHalfCysRateVolSqure0R8150Hz480V;
            udwHalfCysRateVolSqure1R21 = cHalfCysRateVolSqure1R2150Hz480V;
            udwHalfCysRateVolSqure0R2 = cHalfCysRateVolSqure0R250Hz480V;
            udwHalfCysRateVolSqure0R01 = cHalfCysRateVolSqure0R0150Hz480V;
        }
    }
    
    if(wEepromRatePowerSel == 0)
    {
    	dwRatePower = 25000;
    }
    else
    ...
    if(wEepromRateVolSel == 0)
    {
    	wRateGridLineVol = 6400;//400V
    	wpuGridLineVol = ((INT32S)((INT32S)wRSGridRmsVol + wSTGridRmsVol + wTRGridRmsVol) * 13981)>>14;
    }
    else
    {    	
    	wRateGridLineVol = 7680;//480V   	
        wpuGridLineVol = ((INT32S)((INT32S)wRSGridRmsVol + wSTGridRmsVol + wTRGridRmsVol) * 11651)>>14;
    }
    
    wRateRmsCurr = (((INT64S)dwRatePower * 9459)/wRateGridLineVol)>>2;//1/SQRT(3)  Q8
    wRateInvCurrPeak = ((INT32S)wRateRmsCurr * 23170)>>14;
    wRateInvCurrInv = (INT32S)134217728/wRateInvCurrPeak;
    wInvCurrPeakMax = ((INT32S)wRateInvCurrPeak * 18022)>>14;
    wInvCurrResolving = ((INT32S)wRateInvCurrPeak  * cPowerResolving)>>14;    
} 
/*********************************************************************
...
static INT16U uwLVRTDelay = 50;
	...
	{
		udwBusVolRefPrev = udwStdBusVolRefTemp<<3;
	}
...
static INT16U uwDelay4 = 0;
    ...
    if(fDCModeSwitchEn == 1)
    {
    	...
    	else if(fDCModeSwitch == 1)//1,2 or 3,4 Runing
    	{
	    	...
	    	if(((fActiveMode == 0)&&(abs(wActivePowerPer)> 8192))||((fActiveMode == 1)&&(abs(wDCCurrAim)> cCurr25A)))
	    	{
	    		fDCModeSwitch = 2;
	    	    fBiDirDCEnOut = 3;
	    	}
...
//	}
//	if(fLVRTValue < uwLVRTActiveValue)    //跌落发生时，由于低通滤波的作用，会使频率产生偏移，虼嗽跌浞⑸蔽智?0ms的德?
//    {
...
static INT32S dwAngIngSubBak[3] = {0,0,0};
	...
	if(fLVRTValue < uwLVRTActiveValue)    //跌落发生时，由于低通滤波的作用，会使频率产生偏移，因此在跌落发生时维持前20ms的频率
    {
    	uwGirdFreqBak[1] = uwGirdFreqBak[0];
        uwGirdFreqBak[2] = uwGirdFreqBak[0];
...
/*********************************************************************
Function name:  INT16S sIqRefExtract(void)
Description: 
Calls:      	 
Called By:  main(void)
Parameters:  void
Return:  void      
 *********************************************************************/
INT16S sIqRefExtract(T_THREE_PHASE_DQO *ptInvCurrRefDqo)
{
...
//static INT16U uwDelay1s = 0;
	...
	//==================================I2t超限引起的降额================================
	wCurrdiff = ((INT32S)wMaxRmsCurr<<14)/wRateRmsCurr;		
    ...
    //uwpuCurrOut = ((INT32U)uwpuCurrOut * wRateInvCurrPeak)>>14;//实际允许的最大输出电流
...
INT32S dwDCPowerTmp,dwIdLimtAim,dwIdLimStep,dwDCCurrStep;
INT16U uwpuActivePowerMax = 16384;
    ...
    if(fActiveMode == 0)
    {
    	...
    	dwDCPowerTmp = (dwDCPowerTmp<<2)/dwRatePower;//Q10
    	...
    	dwActivePowerAim = ((INT64S)dwRatePower * wPRef)>>10;//Q4
    }
    ...
    {
        wTemp = wRSGridRmsVol + wSTGridRmsVol + wTRGridRmsVol;
                
        uwpuGridI = ((INT32U)wRateGridLineVol * 12288)/wTemp;//电网标幺值的倒数
        ...
        wIdLimitMax = ((INT32S)wPRef * wRateInvCurrPeak)>>14;
        ...
        {                                               
            wInvDsCurrLimitLow = -wRateInvCurrPeak;
			dwIdLimitLow = (INT32S)wInvDsCurrLimitLow<<10;
        ...
        {            
            wInvDsCurrLimitHigh = ((INT32S)wRateInvCurrPeak * 10922)>>14;//2/3 = 66%
			dwIdLimitHigh = (INT32S)wInvDsCurrLimitHigh<<10;
...
static INT32S dwIqRef = 0;
    ...
    {      
        ...
        wTemp = ((INT32U)wRateInvCurrPeak * uwCurrMax)>>14;
        dwTemp = dwTemp/wTemp;
    ...
    else
    {
        ...
        dwReactivePowerAim = ((INT64S)dwRatePower * wReactivePowerPer)>>6;//Q8     
        wTemp = ((INT32S)wRSGridRmsVol + wSTGridRmsVol + wTRGridRmsVol)>>4;   
        wTemp = ((INT32S)wTemp * 9459)>>14;   
...
/********************************************************************* 
Function name:void sfPowerComdCal(void)							  
Description:  Check power status
Calls:																   
Called By:	sSysMode(void)											   
Parameters:  void													   
...
static INT16U fFreOVStartOrEnd = 0,fFreUnStartOrEnd = 0;
static INT16S wFreMax = 0,wFreMin = 0;
static INT16S wQAimTemp = 0;
static INT16U uwDelay1s = 0;
...
INT16S wDCChargeCurrLimit,wDCDisChargeCurrLimit;
    ...
    if(wEepromRateFreqSel == 1)
    {
        wUnFreTripFre = ((INT32S)(wEepromUnFreTripFre + 6000)* 10486)>>12;
        wOVFreTripFre = ((INT32S)(wEepromOVFreTripFre + 6000)* 10486)>>12;
        wUnFreExitFre = ((INT32S)(wEepromUnFreExitFre + 6000)* 10486)>>12;
        wOVFreExitFre = ((INT32S)(wEepromOVFreExitFre + 6000)* 10486)>>12;
    }
    else
    {
        wUnFreTripFre = ((INT32S)(wEepromUnFreTripFre + 5000)* 10486)>>12;
        wOVFreTripFre = ((INT32S)(wEepromOVFreTripFre + 5000)* 10486)>>12;
        wUnFreExitFre = ((INT32S)(wEepromUnFreExitFre + 5000)* 10486)>>12;
        wOVFreExitFre = ((INT32S)(wEepromOVFreExitFre + 5000)* 10486)>>12;
    }
    ...
    if((fLVRTValue > uwLVRTActiveValue)&&(fHVRTValue < uwHVRTActiveValue))
    {
        if(wEepromUnFreDisChargeEn == 1)
        {
        	if(wGridCrossZeroFreqMin < wUnFreTripFre)
        	{
        		...
        		if(uwUnFreCnt < 5)
                {
                    wPUnFrefrozen = (INT16S)(((INT64S)(dwInvActivePower[3]>>4) * 1000)/dwRatePower);
                }
                else if(uwUnFreCnt >= 5)
                {
                    ...
                    wTemp = ((INT32S)wFreMin * wEepromUnFreRatio)>>8;//wEepromUnFreRatio 为正
        ...
        if(wEepromOVFreChargeEn == 1)
        {
            ...
            {                
                ...
                if(uwOVFreCnt < 5)
                {
                    wPOVFrefrozen = (INT16S)(((INT64S)(dwInvActivePower[3]>>4) * 1000)/dwRatePower);
                }
                else if(uwOVFreCnt >= 5)//连续5次即20ms发生过频时
                {
                    ...
                    wTemp = ((INT32S)wFreMax * wEepromOVFreRatio)>>8;
    ...
    if(((wEepromOVFreChargeEn == 0)||(fFreOVStartOrEnd == 0))&&((wEepromUnFreDisChargeEn == 0)||(fFreUnStartOrEnd == 0)))
    {
    ...
    else
    {
		...
		{
			wLockInVolt = ((INT32S)wEepromPF_PCurveLockInV * wRateGridLineVol)/1000;
            wLockOutVolt = ((INT32S)wEepromPF_PCurveLockOutV * wRateGridLineVol)/1000;
            ...
            if((wRSGridRmsVol > wLockInVolt) || (wSTGridRmsVol > wLockInVolt) || (wTRGridRmsVol > wLockInVolt))
            {
                ...
                wActivePPerTemp = (INT16S)(((INT64S)(dwInvActivePower[3]>>4) * 1000)/dwRatePower);
        ...
        {         	
            ...
            if(wActivePPerTemp > wEepromQ_UCurveLockInP)
            {
            	if(++uwDelay1s >= 10)
            	{
            		uwDelay1s = 10;
            		wTemp = wRSGridRmsVol + wSTGridRmsVol + wTRGridRmsVol;            	
            	    wTemp = (((INT32S)wTemp * 10667)>>5)/wRateGridLineVol;
                    
                    if(wTemp >= wEepromQ_UCurveVolt2s)
                    {
                    	wQAimTemp = wEepromQ_UCurveReactPw2s;
                    }
                    else if(wTemp <= wEepromQ_UCurveVolt2i)
                    {
                    	wQAimTemp = wEepromQ_UCurveReactPw2i;
                    }
                    else
                    {
                    	if(wTemp >= wEepromQ_UCurveVolt1s)
                    	{
                    		wErr1 = wEepromQ_UCurveVolt1s - wTemp;
                            wErr2 = wTemp - wEepromQ_UCurveVolt2s;
                            
                            dwTemp = (INT32S)wErr2 * wEepromQ_UCurveReactPw1s + (INT32S)wErr1 * wEepromQ_UCurveReactPw2s;
                            wErr2 = wErr1 + wErr2;
                            wQAimTemp = dwTemp/wErr2;
                    	}
                    	else if(wTemp <= wEepromQ_UCurveVolt1i)
                    	{
                    		wErr1 = wEepromQ_UCurveVolt1i - wTemp;
                            wErr2 = wTemp - wEepromQ_UCurveVolt2i;
                            
                            dwTemp = (INT32S)wErr2 * wEepromQ_UCurveReactPw1i + (INT32S)wErr1 * wEepromQ_UCurveReactPw2i;
                            wErr2 = wErr1 + wErr2;
                            wQAimTemp = dwTemp/wErr2;
                    	}
                    	else
            ...
            if(wQAimTemp >= 0)
			{
                wReactivePowerPer = ((INT32S)wQAimTemp * cDectoHex + 512)>>10;
			}
			else
			{
                wReactivePowerPer = ((INT32S)wQAimTemp * cDectoHex - 512)>>10;
