...
{
	0x0,                         0x1,                       0x1,                       0x2710,              
    //reserver                   wRemoteCSVSSwitch          wRemoteVSCtrEn             wRemoteVSFreSet
    0x14A0,                      0x1,                       0x1,                       0x44c,                                
    //wRemoteVSVolSet            wRemoteCSPCtrEn            wRemoteCSPCtrModeSel       wRemoteCSPPer  
    0x1B58,                      0x1,                       0x1,                       0x3E8,            
    //wRemoteCSCurrSet           wRemoteCSQCtrEn            wRemoteCSQCtrModeSel       wRemoteCSPFSet
    0x258,                       1,                         1,                         0,                                
    //wRemoteCSQPer              wRemoteK7Ctr               fRemotePCSComdOn           reserver    
    0,                           0,                         0,                         0,   
...
const INT16S wRemoteDataMin[ ] = 
{
    ...
    //wRemoteCSCurrSet           wRemoteCSQCtrEn            wRemoteCSQCtrModeSel       wRemoteCSPFSet
    0xFDA8,                      0,                         0,                         0,                                
    //wRemoteCSQPer              wRemoteK7Ctr               fRemotePCSComdOn           fRemotePCSComdOff    
    0,                           0,                         0,                         0,   
    //reserver                   reserver                   reserver                   reserver 
    0,                           0,                         0,                         0,   
    //reserver                   reserver                   reserver                   reserver 
...
void InitECanVar(void)
{
    ...
    //第9组，命令参数
    wHoldRegister[170] = 0x5555;//fDeCapEnergy
    wHoldRegister[171] = 0xA5A5;//fLocalPCSComdOn
    wHoldRegister[172] = 0x5555;//fQuitShutModeOrder
    wHoldRegister[173] = 0x5555;//fCallDefaultValueOrder
    wHoldRegister[174] = 0x5555;//fAutoTest
    wHoldRegister[175] = 0;
    wHoldRegister[176] = 0xA5A5;//fLocalPCSConnect
    wHoldRegister[177] = 0;

    //Remote Data
    wRemoteData[0] = 0;     //reserver
    wRemoteData[1] = 0;     //wRemoteCSVSSwitch
    wRemoteData[2] = 0;     //wRemoteVSCtrEn
    wRemoteData[3] = 6000;  //wRemoteVSFreSet
    wRemoteData[4] = 1000;  //wRemoteVSVolSet
...
INT16S wSysFreq;
    ...
    if(wHoldRegister[173] == 0xAAAA)  //恢复出厂
    {
        if(fCallDefaultValueOrder == 0)
        {
            fCallDefaultValueOrder = 2;
            wHoldRegister[173] = 0xA5A5; 
            ...
            wHoldRegister[58] = wEepromUserSave2;//reserver
            wHoldRegister[59] = wEepromUserSave3;//reserver
            ...
            wHoldRegister[100] = wEepromOVFreChargeEn;
            wHoldRegister[101] = wEepromOVFreTripFre + wSysFreq;
            wHoldRegister[102] = wEepromOVFreRatio;            
            wHoldRegister[103] = wEepromOVFreExitFre + wSysFreq;			
            wHoldRegister[104] = wEepromUnFreDisChargeEn;            
            wHoldRegister[105] = wEepromUnFreTripFre + wSysFreq;            
            wHoldRegister[106] = wEepromUnFreRatio;
            wHoldRegister[107] = wEepromUnFreExitFre + wSysFreq;
            wHoldRegister[108] = 0;//reserver
            wHoldRegister[109] = 0;//reserver
            //第6组，LVRT功能设置
            wHoldRegister[110] = wEepromLVRTOption;
            wHoldRegister[111] = wEepromLVRTTripVol; 
            wHoldRegister[112] = wEepromFVRTPosCurrK;
            wHoldRegister[113] = wEepromFVRTNegCurrK;
			wHoldRegister[114] = wEepromHVRTOption;//reserver
            wHoldRegister[115] = wEepromHVRTTripVol;//reserver
            wHoldRegister[116] = wEepromFVRTPowerStep;//reserver
            wHoldRegister[117] = 0;//reserver
            wHoldRegister[118] = 0;//reserver
            wHoldRegister[119] = 0;//reserver
            //第7组，电池参数设置
            wHoldRegister[120] = wEepromChargeVoltLimt;
            wHoldRegister[121] = wEepromDisChargeVoltLimt;
            wHoldRegister[122] = wEepromChargeCurrLimt;
            wHoldRegister[123] = wEepromDisChargeCurrLimt; 
            wHoldRegister[124] = wEepromFloatChargeVolt;
            wHoldRegister[125] = wEepromSToFChargeCurr;
            wHoldRegister[126] = wEepromBatteryVoltMax;
            wHoldRegister[127] = wEepromBatteryVoltMin;
            wHoldRegister[128] = wEepromBatChargeCurrMax;
            wHoldRegister[129] = wEepromBatDisChargeCurrMax; 
            wHoldRegister[130] = wEepromDCRelayVoltDiff;      
            wHoldRegister[131] = wEepromBatPreChargeCurrMax; 
			wHoldRegister[132] = 0;
            wHoldRegister[133] = wEepromCSVSSwitch;
            wHoldRegister[134] = wEepromVSSynctoGridEn;
            wHoldRegister[135] = wEepromVSCtrModel;        
            wHoldRegister[136] = wEepromVSVolSet;    
            wHoldRegister[137] = wEepromVSFreSet;        
            wHoldRegister[138] = wEepromVSPSet;
            wHoldRegister[139] = wEepromVSQSet;
            wHoldRegister[140] = wEepromVSDroopEn;
            wHoldRegister[141] = wEepromVSPCtrFreK;
            wHoldRegister[142] = wEepromVSQCtrUK;
            wHoldRegister[143] = 0;//reserver
            wHoldRegister[144] = 0;//reserver
            wHoldRegister[145] = 0;//reserver
            // 其它参数
            wHoldRegister[146] = wEepromInvCurrMax;
            wHoldRegister[147] = wEepromDCIOffsetDiffMax;
            wHoldRegister[148] = wEepromOffsetDiffMax;
            wHoldRegister[149] = wEepromEnvironmentTmpMax;
            wHoldRegister[150] = wEepromPowerTmpMax;
            wHoldRegister[151] = wEepromXFMRTmpMax;
            wHoldRegister[152] = wEepromTransformerTmpMax;
            wHoldRegister[153] = wEepromBusVolMax;
            wHoldRegister[154] = wEepromCapVolMax;
            wHoldRegister[155] = wEepromDCRelayActProt;
            wHoldRegister[156] = wEepromBiDirDCSwitch;
            wHoldRegister[157] = wEepromRemoteSel;
            wHoldRegister[158] = wEepromBatteryType;
            wHoldRegister[159] = 0;
            wHoldRegister[160] = 0;
            wHoldRegister[161] = 0;
            wHoldRegister[162] = 0;
    ...
    else if(wHoldRegister[173] == 0xA5A5)
    {
        if(fCallDefaultValueOrder == 0)
        {
            wHoldRegister[173] = 0x5555;
        }   
    }    	    
    else if(wHoldRegister[173] == 0x5555)
    {
        wHoldRegister[173] = 0x5555;
    }  
    else
    {
        wHoldRegister[173] = 0x7777;
    }
    
    if(wHoldRegister[170] == 0xAAAA) //快速放电...
    {
        if(fRunOrder == 0)
        {
            fDeCapEnergy = 1;
            wHoldRegister[170] = 0xA5A5;
        }
        else
        {
            wHoldRegister[170] = 0x7777;
        }
    }
    else if(wHoldRegister[170] == 0xA5A5) 
    {
        if(fDeCapEnergy == 0)
        {
            wHoldRegister[170] = 0x5555;
        }
    ...
    if(wHoldRegister[171] == 0xAAAA)//开机
    {
	...
	{
	    if(wHoldRegister[172] == 0xaaaa) 
	    {	
	        if(uwSysMode == ShutMode)
	        {	
  	    	    fQuitShutModeOrder = 1;
  	    	    wHoldRegister[172] = 0xa5a5;      	
	        }	            
  	        else
  	        {
  	     	    fQuitShutModeOrder = 0;
  	            wHoldRegister[172] = 0x5555;
  	        }      	
	    }
	    else if(wHoldRegister[172] == 0xa5a5)
	    {
	    	wHoldRegister[172] = 0x5555;
	    }            
	}
...
void sHoldDataDeal(void)
{
    ...
    if(wEepromRateFreqSel != wSysFrebak)
    {        
        if(wEepromRateFreqSel == 1)
        {
            wSysFreq = 6000;
    ...
    {  	        
        ...
        j = &wEepromLVRTOption - &wEepromProtectData[0];   
        if(wHoldRegister[110] != wEepromLVRTOption) 
	    {
            i = wHoldRegister[110];
            if((i <= *(pwEepromDefaultProtMaxArray+j)) && (i >= *(pwEepromDefaultProtMinArray+j)) && (wEepromStandardValue != cNoStandard))
	        {
        ...
        wEepromSum04 = (INT16U)wEepromGridFreqMin_2 + (INT16U)wEepromFreqMinTripTime_2 + (INT16U)wEepromGridFreqRecover_Max +
                       (INT16U)wEepromGridFreqRecover_Min + (INT16U)wEepromGridFreqRecover_Time + (INT16U)wEepromLVRTOption;                                    
        
        
        j = &wEepromLVRTTripVol - &wEepromProtectData[0];	    
        if(wHoldRegister[111] != wEepromLVRTTripVol)  
        {
            i = wHoldRegister[111];  
            if((i <= *(pwEepromDefaultProtMaxArray+j)) && (i >= *(pwEepromDefaultProtMinArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        j = &wEepromHVRTOption - &wEepromProtectData[0];   
        if(wHoldRegister[114] != wEepromHVRTOption) 
	    {
            i = wHoldRegister[114];
            if((i <= *(pwEepromDefaultProtMaxArray+j)) && (i >= *(pwEepromDefaultProtMinArray+j)) && (wEepromStandardValue != cNoStandard))
	        {
                wEepromHVRTOption = i;
                wHoldRegister[114] = wEepromHVRTOption;
                fEepromOperateRequire = 1;
		    } 
		    else
		    {
        ...
        if(wHoldRegister[115] != wEepromHVRTTripVol)  
        {
            i = wHoldRegister[115];  
            if((i <= *(pwEepromDefaultProtMaxArray+j)) && (i >= *(pwEepromDefaultProtMinArray+j)) && (wEepromStandardValue != cNoStandard))
            {
                wEepromHVRTTripVol = i;
                wHoldRegister[115] = wEepromHVRTTripVol;
                fEepromOperateRequire = 1;
            }
            else
            {
        ...
        if(wHoldRegister[112] != wEepromFVRTPosCurrK) 
        {
            i = wHoldRegister[112];
            if((i <= *(pwEepromDefaultProtMaxArray+j)) && (i >= *(pwEepromDefaultProtMinArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        if(wHoldRegister[113] != wEepromFVRTNegCurrK) 
        {
            i = wHoldRegister[113];
            if((i <= *(pwEepromDefaultProtMaxArray+j)) && (i >= *(pwEepromDefaultProtMinArray+j)) && (wEepromStandardValue != cNoStandard))
            {
	    ...
	    if(wHoldRegister[116] != wEepromFVRTPowerStep) 
	    {
	        i = wHoldRegister[116];
	        if((i <= *(pwEepromDefaultProtMaxArray+j)) && (i >= *(pwEepromDefaultProtMinArray+j)) && (wEepromStandardValue != cNoStandard))
	        {
	            wEepromFVRTPowerStep = i;
	            wHoldRegister[116] = wEepromFVRTPowerStep;
	            fEepromOperateRequire = 1; 
	        }
	        else
	        {
        ...
        wEepromSum05 = (INT16U)wEepromLVRTTripVol + (INT16U)wEepromHVRTOption + (INT16U)wEepromHVRTTripVol +
                       (INT16U)wEepromFVRTPosCurrK + (INT16U)wEepromFVRTNegCurrK + (INT16U)wEepromFVRTPowerStep;    


        j = &wEepromOVFreChargeEn - &wEepromProtectData[0];   
        if(wHoldRegister[100] != wEepromOVFreChargeEn) 
        {
            i = wHoldRegister[100];
            if((i <= *(pwEepromDefaultProtMaxArray+j)) && (i >= *(pwEepromDefaultProtMinArray+j)) && (wEepromStandardValue != cNoStandard))
            {
                wEepromOVFreChargeEn = i;                   
                wHoldRegister[100] = wEepromOVFreChargeEn;
                fEepromOperateRequire = 1;
            }
            else
        ...
        j = &wEepromOVFreTripFre - &wEepromProtectData[0];   
        if(wHoldRegister[101] != (wEepromOVFreTripFre + wSysFreq))
        {
            i = wHoldRegister[101] - wSysFreq;            
            if((i <= *(pwEepromDefaultProtMaxArray+j)) && (i >= *(pwEepromDefaultProtMinArray+j)) && (wEepromStandardValue != cNoStandard))
            {
                wEepromOVFreTripFre = i;
                wHoldRegister[101] = wEepromOVFreTripFre + wSysFreq;
                fEepromOperateRequire = 1;
            }
            else
        ...
        j = &wEepromOVFreRatio - &wEepromProtectData[0];        
        if(wHoldRegister[102] != wEepromOVFreRatio)
        {
            i = wHoldRegister[102];
            if((i <= *(pwEepromDefaultProtMaxArray+j)) && (i >= *(pwEepromDefaultProtMinArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        j = &wEepromOVFreExitFre - &wEepromProtectData[0];   
        if(wHoldRegister[103] != (wEepromOVFreExitFre + wSysFreq))
        {
            i = wHoldRegister[103] - wSysFreq;
            if((i <= *(pwEepromDefaultProtMaxArray+j)) && (i >= *(pwEepromDefaultProtMinArray+j)) && (wEepromStandardValue != cNoStandard))
            {
                wEepromOVFreExitFre = i;
                wHoldRegister[103] = wEepromOVFreExitFre + wSysFreq;
                fEepromOperateRequire = 1;
            }
            else
        ...
        j = &wEepromUnFreDisChargeEn - &wEepromProtectData[0];   
        if(wHoldRegister[104] != wEepromUnFreDisChargeEn)
        {
            i = wHoldRegister[104];
            if((i <= *(pwEepromDefaultProtMaxArray+j)) && (i >= *(pwEepromDefaultProtMinArray+j)) && (wEepromStandardValue != cNoStandard))
            {
                wEepromUnFreDisChargeEn = i;
                wHoldRegister[104] = wEepromUnFreDisChargeEn;
                fEepromOperateRequire = 1;
            }
            else
        ...
        j = &wEepromUnFreTripFre - &wEepromProtectData[0];   
        if(wHoldRegister[105] != (wEepromUnFreTripFre + wSysFreq))
        {
            i = wHoldRegister[105] - wSysFreq;            
            if((i <= *(pwEepromDefaultProtMaxArray+j)) && (i >= *(pwEepromDefaultProtMinArray+j)) && (wEepromStandardValue != cNoStandard))
            {
                wEepromUnFreTripFre = i;
                wHoldRegister[105] = wEepromUnFreTripFre + wSysFreq;
                fEepromOperateRequire = 1;
            }
            else
        ...
        wEepromSum06 = (INT16U)wEepromOVFreChargeEn + (INT16U)wEepromOVFreTripFre + (INT16U)wEepromOVFreRatio +
                       (INT16U)wEepromOVFreExitFre + (INT16U)wEepromUnFreDisChargeEn + (INT16U)wEepromUnFreTripFre;
        
        
        j = &wEepromUnFreRatio - &wEepromProtectData[0];   
        if(wHoldRegister[106] != wEepromUnFreRatio)
        {
            i = wHoldRegister[106];
            if((i <= *(pwEepromDefaultProtMaxArray+j)) && (i >= *(pwEepromDefaultProtMinArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        j = &wEepromUnFreExitFre - &wEepromProtectData[0];   
        if(wHoldRegister[107] != (wEepromUnFreExitFre + wSysFreq))
        {
            i = wHoldRegister[107] - wSysFreq;
            if((i <= *(pwEepromDefaultProtMaxArray+j)) && (i >= *(pwEepromDefaultProtMinArray+j)) && (wEepromStandardValue != cNoStandard))
            {
                wEepromUnFreExitFre = i;
                wHoldRegister[107] = wEepromUnFreExitFre + wSysFreq;
                fEepromOperateRequire = 1;
            }
            else
        ...
        wEepromSum07 = (INT16U)wEepromUnFreRatio + (INT16U)wEepromUnFreExitFre + (INT16U)wEepromPF_PCurveActPw1 +         
        ...
        j = &wEepromAIEnable - &wEepromProtectData[0];	    
        ...
        j = &wEepromUserSave2 - &wEepromProtectData[0];	    
        if(wHoldRegister[58] != wEepromUserSave2)
        {
            i = wHoldRegister[58];
            if((i <= *(pwEepromDefaultProtMaxArray+j)) && (i >= *(pwEepromDefaultProtMinArray+j)) && (wEepromStandardValue != cNoStandard))
            {
                wEepromUserSave2 = i;
                wHoldRegister[58] = wEepromUserSave2; 
                fEepromOperateRequire = 1;
            }
            else
            {
        ...
        j = &wEepromUserSave3 - &wEepromProtectData[0];	    
        if(wHoldRegister[59] != wEepromUserSave3)
        {
            i = wHoldRegister[59];
            if((i <= *(pwEepromDefaultProtMaxArray+j)) && (i >= *(pwEepromDefaultProtMinArray+j)) && (wEepromStandardValue != cNoStandard))
            {
                wEepromUserSave3 = i;
                wHoldRegister[59] = wEepromUserSave3; 
                fEepromOperateRequire = 1;
            }
            else
            {
        ...
        wEepromSum10 = (INT16U)wEepromIsoImpMin + (INT16U)wEepromGFCIMax + (INT16U)wEepromDCIMax +  
                       (INT16U)wEepromAIEnable + (INT16U)wEepromUserSave2 + (INT16U)wEepromUserSave3;  
        
        j = &wEepromChargeVoltLimt - &wEepromProtectSupplData[0];	    
        if(wHoldRegister[120] != wEepromChargeVoltLimt)
        {
            i = wHoldRegister[120];
        ...
        if(wHoldRegister[121] != wEepromDisChargeVoltLimt)
        {
            i = wHoldRegister[121];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        if(wHoldRegister[122] != wEepromChargeCurrLimt)
        {
            i = wHoldRegister[122];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        if(wHoldRegister[123] != wEepromDisChargeCurrLimt)
        {
            i = wHoldRegister[123];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        if(wHoldRegister[124] > wEepromChargeVoltLimt)
        {
        	wHoldRegister[124] = wEepromChargeVoltLimt;
        }
        else if(wHoldRegister[124] < (wEepromChargeVoltLimt - 500))
        {
        	wHoldRegister[124] = wEepromChargeVoltLimt - 500;
        }   
        if(wHoldRegister[124] != wEepromFloatChargeVolt)
        {
            i = wHoldRegister[124];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        if(wHoldRegister[125] != wEepromSToFChargeCurr)
        {
            i = wHoldRegister[125];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        if(wHoldRegister[126] <= (wEepromChargeVoltLimt + 10))
        {
        	wHoldRegister[126] = wEepromChargeVoltLimt + 10;
        } 
        if(wHoldRegister[126] != wEepromBatteryVoltMax)
        {
            i = wHoldRegister[126];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        if(wHoldRegister[127] >= (wEepromDisChargeVoltLimt - 10))
        {
        	wHoldRegister[127] = wEepromDisChargeVoltLimt - 10;
        }     
        if(wHoldRegister[127] != wEepromBatteryVoltMin)
        {
            i = wHoldRegister[127];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        if(wHoldRegister[128] != wEepromBatChargeCurrMax)
        {
            i = wHoldRegister[128];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        if(wHoldRegister[129] != wEepromBatDisChargeCurrMax)
        {
            i = wHoldRegister[129];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        if(wHoldRegister[130] != wEepromDCRelayVoltDiff)
        {
            i = wHoldRegister[130];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        if(wHoldRegister[131] != wEepromBatPreChargeCurrMax)
        {
            i = wHoldRegister[131];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        if(wHoldRegister[157] != wEepromRemoteSel)
        {
            i = wHoldRegister[157];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        if(wHoldRegister[133] != wEepromCSVSSwitch)
        {
            i = wHoldRegister[133];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        j = &wEepromVSSynctoGridEn - &wEepromProtectSupplData[0];	    
        if(wHoldRegister[134] != wEepromVSSynctoGridEn)
        {
            i = wHoldRegister[134];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
                wEepromVSSynctoGridEn = i;
                wHoldRegister[134] = wEepromVSSynctoGridEn; 
                fEepromOperateRequire = 1;
            }
            else
        ...
        j = &wEepromVSCtrModel - &wEepromProtectSupplData[0];	    
        if(wHoldRegister[135] != wEepromVSCtrModel)
        {
            i = wHoldRegister[135];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        j = &wEepromVSVolSet - &wEepromProtectSupplData[0];	    
        if(wHoldRegister[136] != wEepromVSVolSet)
        {
            i = wHoldRegister[136];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        j = &wEepromVSFreSet - &wEepromProtectSupplData[0];	    
        if(wHoldRegister[137] != wEepromVSFreSet)
        {
            i = wHoldRegister[137];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        wEepromSupplSum03 = (INT16U)wEepromRemoteSel + (INT16U)wEepromCSVSSwitch + (INT16U)wEepromVSSynctoGridEn +            
                            (INT16U)wEepromVSCtrModel + (INT16U)wEepromVSVolSet + (INT16U)wEepromVSFreSet; 

        
        j = &wEepromVSPSet - &wEepromProtectSupplData[0];	    
        if(wHoldRegister[138] != wEepromVSPSet)
        {
            i = wHoldRegister[138];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        if(wHoldRegister[139] != wEepromVSQSet)
        {
            i = wHoldRegister[139];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        if(wHoldRegister[140] != wEepromVSDroopEn)
        {
            i = wHoldRegister[140];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        j = &wEepromVSPCtrFreK - &wEepromProtectSupplData[0];	    
        if(wHoldRegister[141] != wEepromVSPCtrFreK)
        {
            i = wHoldRegister[141];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        j = &wEepromVSQCtrUK - &wEepromProtectSupplData[0];	    
        if(wHoldRegister[142] != wEepromVSQCtrUK)
        {
            i = wHoldRegister[142];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        wEepromSupplSum04 = (INT16U)wEepromVSPSet + (INT16U)wEepromVSQSet + (INT16U)wEepromVSDroopEn +            
                            (INT16U)wEepromVSPCtrFreK + (INT16U)wEepromVSQCtrUK + (INT16U)wEepromCSPCtrModeSel; 
        ...
        if(wHoldRegister[146] != wEepromInvCurrMax) 
        {
            i = wHoldRegister[146];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        if(wHoldRegister[147] != wEepromDCIOffsetDiffMax) 
        {
            i = wHoldRegister[147];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        if(wHoldRegister[148] != wEepromOffsetDiffMax) 
        {
            i = wHoldRegister[148];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        if(wHoldRegister[149] != wEepromEnvironmentTmpMax) 
        {
            i = wHoldRegister[149];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        if(wHoldRegister[150] != wEepromPowerTmpMax) 
        {
            i = wHoldRegister[150];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        if(wHoldRegister[151] != wEepromXFMRTmpMax) 
        {
            i = wHoldRegister[151];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        if(wHoldRegister[152] != wEepromTransformerTmpMax) 
        {
            i = wHoldRegister[152];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        if(wHoldRegister[153] != wEepromBusVolMax) 
        {
            i = wHoldRegister[153];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        if(wHoldRegister[154] != wEepromCapVolMax) 
        {
            i = wHoldRegister[154];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        if(wHoldRegister[155] != wEepromDCRelayActProt) 
        {
            i = wHoldRegister[155];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        if(wHoldRegister[156] != wEepromBiDirDCSwitch) 
        {
            i = wHoldRegister[156];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
        ...
        if(wHoldRegister[158] != wEepromBatteryType) 
        {
            i = wHoldRegister[158];
            if((i <= *(pwEepromDefaultProtMaxSupplArray+j)) && (i >= *(pwEepromDefaultProtMinSupplArray+j)) && (wEepromStandardValue != cNoStandard))
            {
...
void sInputDataUpdate(void)
{
    ...
    if(wEepromCSVSSwitch == 1)// Bit 10 //Current Source,Voltage Source State
    {
    	i |= 1024;
    }
    ...
    if((fRunInvAhdChkRequire == 1)&&(uwSysMode == PreCheckMode))// Bit 6，Inv Check
    {
        i |= 64;
    }
