...
const INT16U wFlashSafetyCheckCRC = 0x72ed;//wDebugFlashSum
...
#pragma DATA_SECTION(tErrFlag,"RamSafetyProt");
#pragma DATA_SECTION(tEventFlag,"RamSafetyProt");
#pragma DATA_SECTION(uwFaultCode,"RamSafetyProt");

#pragma DATA_SECTION(wGFCIAvgInitArray,"RamSafetyProt");
#pragma DATA_SECTION(wGFCIRmsInitArray,"RamSafetyProt");
#pragma DATA_SECTION(wGFCIAvgActArray,"RamSafetyProt");
#pragma DATA_SECTION(wGFCIRmsActArray,"RamSafetyProt");
#pragma DATA_SECTION(wDeltaGFCIAvgArray,"RamSafetyProt");
#pragma DATA_SECTION(wDeltaGFCIRmsArray,"RamSafetyProt");
#pragma DATA_SECTION(uwGFCIInitArrayIndex,"RamSafetyProt");
#pragma DATA_SECTION(uwGFCIActArrayIndex,"RamSafetyProt");
#pragma DATA_SECTION(dwGFCIAvgInitSum,"RamSafetyProt");
#pragma DATA_SECTION(dwGFCIRmsInitSum,"RamSafetyProt");
#pragma DATA_SECTION(dwGFCIAvgActSum,"RamSafetyProt");
#pragma DATA_SECTION(dwGFCIRmsActSum,"RamSafetyProt");
#pragma DATA_SECTION(uwGFCIHighCnt,"RamSafetyProt");
#pragma DATA_SECTION(uwDeltaGFCIChkDelay100Prd,"RamSafetyProt");
#pragma DATA_SECTION(uwSteadyErrClearDelay10s,"RamSafetyProt");
#pragma DATA_SECTION(uwDeltaGFCIErrClearDelay10s,"RamSafetyProt");

#pragma DATA_SECTION(uwfIsoChkFinished,"RamSafetyProt");
#pragma DATA_SECTION(uwfIsoChkOk,"RamSafetyProt");
#pragma DATA_SECTION(uwIsoChkCounter,"RamSafetyProt");
#pragma DATA_SECTION(dwIsoRlyOpenVngSum,"RamSafetyProt");
#pragma DATA_SECTION(dwIsoRlyCloseVngSum,"RamSafetyProt");
#pragma DATA_SECTION(wIsoRlyOpenVngAvgTemp,"RamSafetyProt");
#pragma DATA_SECTION(wIsoRlyCloseVngAvgTemp,"RamSafetyProt");
#pragma DATA_SECTION(uwIsoSumCnt,"RamSafetyProt");
#pragma DATA_SECTION(uwIsoTimer20msCnt,"RamSafetyProt");
#pragma DATA_SECTION(wIsoImp,"RamSafetyProt");

#pragma DATA_SECTION(fRelayCheckStep,"RamSafetyProt");
#pragma DATA_SECTION(uwInvRelayOKCnt,"RamSafetyProt");
#pragma DATA_SECTION(uwInvRelayBadCnt,"RamSafetyProt");
#pragma DATA_SECTION(uwGridRelayOKCnt,"RamSafetyProt");
#pragma DATA_SECTION(uwGridRelayBadCnt,"RamSafetyProt");
#pragma DATA_SECTION(uwAuxiRelayOKCnt,"RamSafetyProt");
#pragma DATA_SECTION(uwAuxiRelayBadCnt,"RamSafetyProt");
...
INT16S wGridVolMax_1,wGridVolMin_1,wGridVolMax_2,wGridVolMin_2,wGridVolMax_3,wGridVolMin_3,wGridVolRecover_Max,wGridVolRecover_Min;
    ...
    {
    	if(uwLowVolTripTime3 < 250)
    	{
    		uwLowVolTripTime3 = 250;
    	}
    	
    	if(uwLowVolTripTime2 < 250)
    	{
    		uwLowVolTripTime2 = 250;
    	}
    	
    	if(uwLowVolTripTime1 < 250)
    	{
    		uwLowVolTripTime1 = 250;
    	}    	
        
        if(uwHighVolTripTime2 < 3)
        {
        	uwHighVolTripTime2 = 3;
        }
        
        if(uwHighVolTripTime1 < 20)
        {
        	uwHighVolTripTime1 = 20;
        }
    	    	
    	if(fLVRTValue < 2457)
    	{
    		uwLowVolTripTime1 = 40;
    		uwLowVolTripTime2 = 40;
    		uwLowVolTripTime3 = 40;
    	}
    }
    
    if(wEepromHVRTOption == 1)
    {    	
    	if(uwHighVolTripTime1 < 1200)
    	{
    		uwHighVolTripTime1 = 1200;
    	}
    	
    	if(uwLowVolTripTime3 < 5)
        {
        	uwLowVolTripTime3 = 5;
        }
        
        if(uwLowVolTripTime2 < 10)
        {
        	uwLowVolTripTime2 = 10;
        }
        
        if(uwLowVolTripTime1 < 20)
        {
        	uwLowVolTripTime1 = 20;
        }
    }
...
static INT16U uwDelay3s = 150;
    ...
    if((fInvEnOut == 1) && (uwSysMode == InvRunMode)) //逆变运行时DCI故障标志又清又置，其他情况标志只清不置
    {
    	if(fDCIDelayClear == 0)
    	{
    	    uwDCIChkDelay5sCnt = 0;
    ...
    {  	
    	...
    	if((abs(*pRDCI) < (wDCIMax - 80)) && (abs(*pSDCI) < (wDCIMax - 80)) && (abs(*pTDCI) < (wDCIMax - 80)))
    	{
    		uwDCIHighCnt= 0;                                                                       
    		if(++uwErrClearDelay60s > 3000)
    		{
...
void sGridNoUtilityChk(INT16U *pErrFlag,INT16U *pEventFlag)
{
	...
	static INT16U uwNoUtilityCnt = 0;
	...
	if((j == 1) || (i == 1))
	{
	    if(++uwNoUtilityCnt > 40000)  // for  wRSGridVol && wRGridVol
	    {
	        uwNoUtilityCnt = 40000;
	        *pErrFlag = 1; 	
	        fGridPretect = 1;	    
		    if((*pEventFlag) == 0)
            {
...
INT16S wRInvRmsVolReal,wSInvRmsVolReal,wTInvRmsVolReal;
    ...
    wRInvRmsVolReal = wRInvRmsVol - abs(wRInvAvgVol);
    ...
    switch(fRelayCheckStep)
    {
        ...
        case 1:
        	if((wRInvRmsVolReal > (wRGridRmsVol - cVolt80V))||(wSInvRmsVolReal > (wSGridRmsVol - cVolt80V))||(wTInvRmsVolReal > (wTGridRmsVol - cVolt80V)))
            {
            	uwInvRelayBadCnt++;
     	...
     	{                                                                                                  	                                                                                                                           
     		...
     		{                                                                                             
     			case 0:// wait for about 1s ,prepare for calculating Iso average voltage                                                                                                                                                                           	       	                                           
     	       	...
     	       	case 1:                                                                                                                                                        
     	       		uwIsoChkCounter++;                                                                    
     	       		if (uwIsoChkCounter >= 600)   //1*20ms ,wait for Relay close                           
                    {                                                                                     
                    	uwIsoChkCounter = 0;  
     			...
     			case 3: 
     			    uwIsoChkCounter++;                                                                    
     	       	    if (uwIsoChkCounter >= 600)   //5*20ms ,wait for Relay open                            
                    {                                                                                     
                  	    uwIsoChkCounter = 0;   
                  	    uwIsoSumCnt = 0;
                  	    dwIsoRlyCloseVngSum = 0;                                                
     	        ...
     	        case 4:                                                                               
     				...
     				if(uwIsoSumCnt >= 128)                                                                 
     				{                                                                                     
     				    wIsoRlyCloseVngAvgTemp = (INT16S)(dwIsoRlyCloseVngSum>>7);                               
     				    dwIsoRlyCloseVngSum = 0;                                                          
     				    uwIsoSumCnt = 0;                                                                      				                                        
     			...
     			case 5: //calculate the uwIsoRp and uwIsoRn
     			    { 
     			        ...
     			        {
     			            dwIsoImpTemp = ((INT64S)dwVoSubVc * cTestResImp)/dwDualVcSubVo;
     			            
     			            if(fBMSActive == 1)
     			            {
     			                if(dwIsoImpTemp > 1999)
					    	    {
					    	        dwIsoImpTemp = 1999;
					    	    }
     			                
     			                dwIsoImpTemp = ((INT64S)dwIsoImpTemp * 2000)/(2000 - dwIsoImpTemp);
     			            ...
     			            else
     			            {
     			                if(dwIsoImpTemp > 699)
					    	    {
     			                ...
     			                dwIsoImpTemp = ((INT64S)dwIsoImpTemp * 700)/(700 - dwIsoImpTemp);
...
INT16U uwExitTimeSet;
    ...
    {
        if(++uwBalanceDegreeDoubleHighCnt > 10)
        {
            uwBalanceDegreeDoubleHighCnt = 10;
            uwErrClearDelay1m = 0;
	        *pErrFlag = 1;
	        fGridPretect = 1;
    ...
    {
        if(++uwBalanceDegreeHighCnt > 60)   //30s
        {                                  
            uwBalanceDegreeHighCnt = 60;     
            uwErrClearDelay1m = 0;          
            *pErrFlag = 1;
            fGridPretect = 1;                  
...
static INT16U uwFaultCodeHoldCnt = 0;
	   ...
	   ||fCANNoAcitveErrEvent)
	{
   	    ...
   	    if(fStartOrNormal == 1)
		{
			...
			uwFaultCode[3] = fCANNoAcitveErrEvent*2 + fDCPWMErrEvent*4 + fDCSoftRelayErrEvent*8 + fCPLDOsciErrEvent*16 + fDCSwitchErrEvent*32 + fBusDiffBatVolErrEvent*64
...
Return:  void      
**********************************************************************/
void sGridVolAndInvVolDiffChk(T_THREE_PHASE_ABC tGridPhaseVol,T_THREE_PHASE_ABC tInvPhaseVol,INT16U *pErrFlag,INT16U *pEventFlag)
{
static INT16U uwErrClearDelay2s = 0;
...
INT16U fErrEnable = 1;
    ...
    if((fInvEnOut == 1)&&(fRunInvAhdChkRequire == 1))
    {
	    ...
	    if(((abs(tGridPhaseVol.a - tInvPhaseVol.a) > cVolt100V) || (abs(tGridPhaseVol.b - tInvPhaseVol.b) > cVolt100V)
	    || (abs(tGridPhaseVol.c - tInvPhaseVol.c) > cVolt100V))&&(fErrEnable == 1)&&(uwStartDelay >= 240))
	    {
...
static INT16U uwLen = 0x80;
    ...
    if(dwFlashAddr >= (0x338001 + 0x3ffd))
    {
        uwLen = 0x80;
