...
typedef struct {
 ...
 INT16S wGFCIAvgInitArray[8];
 INT16S wGFCIRmsInitArray[8];
 INT16S wGFCIAvgActArray[30];
 INT16S wGFCIRmsActArray[30];
 INT16S wDeltaGFCIAvgArray[30];
 INT16S wDeltaGFCIRmsArray[30];
 INT16U uwGFCIInitArrayIndex;
 INT16U uwGFCIActArrayIndex;

 INT32S dwGFCIAvgInitSum;
 INT32S dwGFCIRmsInitSum;
 INT32S dwGFCIAvgActSum;
 INT32S	dwGFCIRmsActSum;

 INT16U uwGFCIHighCnt;
 INT16U uwDeltaGFCIChkDelay100Prd;
 INT16U uwSteadyErrClearDelay10s;
 INT16U uwDeltaGFCIErrClearDelay10s
 INT16U	uwfIsoChkFinished;
 INT16U	uwfIsoChkOk;
 INT16U	uwIsoChkCounter;

 INT32S dwIsoRlyOpenVngSum;
 INT32S dwIsoRlyCloseVngSum;

 INT16S wIsoRlyOpenVngAvgTemp;
 INT16S wIsoRlyCloseVngAvgTemp;

 INT16U uwIsoSumCnt;
 INT16U uwIsoTimer20msCnt;
 INT16S wIsoImp;

 INT16U fRelayCheckStep;
 INT16U uwInvRelayOKCnt;
 INT16U uwInvRelayBadCnt;

 INT16U uwGridRelayOKCnt;
 INT16U uwGridRelayBadCnt;
 INT16U uwAuxiRelayOKCnt;
 INT16U uwAuxiRelayBadCnt;
 INT16U uwIsoChkStep;
 INT16U uwDCRelayOpenCnt;
}Protect_Safety_Regs,*pProtect_Safety_Regs;
//---------------------------------------------------------------------------
// Function Prototypes
//
...
extern void sDCPWMChkPreChk(INT16U * pErrFlag, INT16U * pEventFlag);
extern void sACPWMChkPreChk(INT16U * pErrFlag, INT16U * pEventFlag);
...
extern INT16U fDCPWMLostPreChk;
extern INT16U fACPWMLostPreChk;
extern INT16U fDCSoftRelayLost;
extern INT16S wDebugFlashSum;
extern INT32S dwGFCIAvgActSum;
extern INT32S dwGFCIRmsActSum;

extern INT16U UabTemp;
extern INT16U UbcTemp;
extern INT16U UcaTemp;

extern INT16S wIsoRlyOpenVngAvgTemp;
extern INT16S wIsoRlyCloseVngAvgTemp ;
...
#define fDCPWMPreChkErr                 	   tErrFlag.Flag65   //DC LOST PWM ON PRECHK
#define fDCPWMPreChkErrEvent                         tEventFlag.Flag65

#define fACPWMPreChkErr                 	   tErrFlag.Flag66   //AC LOST PWM ON PRECHK
#define fACPWMPreChkErrEvent                   tEventFlag.Flag66
