...
PAGE 0:    /* Program Memory */
   ...
   FLASH_SAFE      : origin = 0x338001, length = 0x003AFD

   FLASH_RTS       : origin = 0x33BAFE, length = 0x000500     /* On-chip FLASH */
...
/*** Compiler Required Sections ***/
  /* Program memory (PAGE 0) sections */ 
   ...
   .text:   {rts2800_ml.lib<ll_div.obj>(.text)}       load>FLASH_RTS  PAGE = 0
