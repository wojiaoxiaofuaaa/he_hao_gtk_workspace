...
PAGE 0:    /* Program Memory */
   BEGIN_M0        : origin = 0x000000, length = 0x000002    
    /* Part of M0SARAM.  Used for "Boot to M0" bootloader mode. */
   L0123SARAM      : origin = 0x008000, length = 0x004000    
    /* SARAM, L0 through L3 combined.  CSM secure */
   
   FLASH_CDEFGH    : origin = 0x320004, length = 0x017AFC     /* On-chip FLASH */
   FLASH_RTS       : origin = 0x337B00, length = 0x000500     /* On-chip FLASH */
...
/*** Compiler Required Sections ***/
  /* Program memory (PAGE 0) sections */ 
   ...
   //.text:          load>FLASH_CDEFGH   PAGE = 0
  // .rts:   {rts2800_ml.lib<ll_div.obj>(.text)}       load>FLASH_RTS  PAGE = 0
  ...
  // .rts             :> FLASH_RTS, PAGE = 0  ,TYPE=DSECT
