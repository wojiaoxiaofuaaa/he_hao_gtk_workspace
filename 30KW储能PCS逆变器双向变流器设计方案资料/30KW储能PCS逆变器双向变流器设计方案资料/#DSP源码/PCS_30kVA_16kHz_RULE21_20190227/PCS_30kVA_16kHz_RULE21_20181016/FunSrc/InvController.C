...
//------------------------------Data Safety-----------------------------------
#pragma DATA_SECTION(fUqUnconv,"RAMSafetyInvConProt1");
#pragma DATA_SECTION(fUqUnconvBak,"RAMSafetyInvConProt2");
#pragma DATA_SECTION(uwSoftLVRTValue,"RAMSafetyInvConProt3");
#pragma DATA_SECTION(uwSoftHVRTValue,"RAMSafetyInvConProt4");
...
{              
	...
	wDebugInvDsCurrRef = wInvDsCurrRef;//>0
	wDebugInvDCCurrRef = wInvDCCurrRef;//<0
	...
	if((uwSysMode == InvRunMode)&&(fLVRTValue > 9830))//&&(fHVRTValue < uwHVRTActiveValue))
	{
		if(++uwDelay >= 25)
		{
            ...
            else if(fAIStart == 1)
            {
            	...
            	wDebugTest2=wDeltaFre;
				wDebugTest3=uwMinFreq;
				wDebugTest5=uwSysFreqReal;
            	if(wDeltaFre > -16)
            	{
            		if(++uwDelay2 >= 4)
            		{
            ...
            //wDebugTest6=dwAIPLLFreqNoise;
			//wDebugTest5=wAISystemNoise;
