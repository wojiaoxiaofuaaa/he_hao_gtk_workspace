...
const INT16U wFlashSafetyCheckCRC = 0xC42A;//wDebugFlashSum
...
#pragma CODE_SECTION(sfCalcIso,"FlashSafety");
...
Return:  INT16U type flag                                                                             
 *********************************************************************/
 INT32S sfCalcIso(INT64S DataUp,INT32S DataDown)
{
	INT32S dwData=0;
	if(DataDown==0)dwData=0;
	else dwData=(INT32S)(DataUp/DataDown);
	return dwData;
}
     			...
     			case 5: //calculate the uwIsoRp and uwIsoRn
     			    { 
     			        ...
     			        if(((dwVoSubVc > 0)&&(dwDualVcSubVo > 0))||((dwVoSubVc < 0)&&(dwDualVcSubVo < 0)))
     			        {
                           ...
                           temp_64s=(INT64S)dwVoSubVc * cTestResImp;
						   dwIsoImpTemp=sfCalcIso(temp_64s,dwDualVcSubVo);
							...
							if(dwIsoImpTemp >=wIsoRestemp)
				    	    {
 			                ...
 			                temp_64s=(INT64S)dwIsoImpTemp * wIsoRestemp;
							temp_32s=wIsoRestemp - dwIsoImpTemp;
							dwIsoImpTemp =sfCalcIso(temp_64s,temp_32s);
