...
extern void StatusPowerCalc(void);
//---------------------------------------------------------------------------
...
extern INT16U fPQPriority;
extern fPCS_State fPCSState;
extern INT16U DisChargeMaxPower;
extern INT16U ChargeMaxPower;
//---------------------------------------------------------------------------
...
#define fSpdState                   1 
#define CPLDTODSPCLKFDB             GpioDataRegs.GPBDAT.bit.GPIO41
//---------------------------------------------------------------------------
// Global symbols defined in source files
//-----------------DC Relay Ctr--------------------
...
/*************************DSP---CPLD CLK HEAT***********************************/
#define DspClkHigh() 	GpioDataRegs.GPBSET.bit.GPIO40=1
#define DspClkLow()  	GpioDataRegs.GPBCLEAR.bit.GPIO40=1
