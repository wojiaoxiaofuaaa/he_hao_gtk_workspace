...
#define wRemoteVSCtrMode            wRemoteData[2]
#define wRemoteVSFreqSet            wRemoteData[3]
#define wRemoteVSVoltSet            wRemoteData[4]
...
#define wRemoteVSPSet               wRemoteData[15]
#define wRemoteVSQSet               wRemoteData[16]
