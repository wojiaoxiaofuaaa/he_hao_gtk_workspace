...
extern T_THREE_PHASE_DQO tGridPosVoltSampDqo;
extern T_THREE_PHASE_DQO tInvPosCurrSampDqo,tInvNosCurrSampDqo,tInvNosCurrDqoRef,tInvPosCurrDqoRef,tVSInvCurrDqoRef;
...
extern INT16S wTorqueM;
extern INT16S wTorqueE;
extern INT16S wTorqueD;
extern INT32S dwDampD;
extern INT32S dwDroopKQ;
extern INT16S wInvDisChargeCurrMax;
extern INT16S wInvChargeCurrMin;
extern INT16S wBusDisChargeVoltRef;
extern INT16S wBusChargeVoltRef;
...
extern INT16S wInvVoltLimit;
extern INT16S wTorqueFrequency;
extern INT16S wImaxTmp;
extern INT16S wVoltDAim;
extern INT16S wVoltQAim;
extern INT16S wVSIdPrev;
extern INT16S wVSIqPrev;
extern INT16S wPLLFrequency;
//---------------------------------------------------------------------------
